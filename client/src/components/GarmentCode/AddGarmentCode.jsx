...
const AddGarmentCode = ({ isOpen, setIsOpen, fetchColor }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post(`${base_url}/api/garments`, { GarmentName }, { withCredentials: true });
            fetchColor();
            setGarmentName("");
            setIsOpen(false);
        } catch (err) {
        ...
        ${isOpen ? "translate-x-0" : "translate-x-full"} overflow-y-auto shadow-lg`}
            ...
            >
                ...
                <div className="flex justify-between items-center p-5 pb-4">
                    <h1 className="text-xl font-semibold">Add New Garment</h1>
                ...
                <form onSubmit={handleSubmit} className="p-5 space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            name="Color ."
                            placeholder="Please Enter Garment name."
                            value={GarmentName}
                            isFocused={isFocused}
